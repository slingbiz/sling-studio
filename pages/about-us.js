...
export default function ContactUs(props) {
  ...
  return (
    <div className={styles.container}>
      <PageMeta title='About Sling React' />
      <main className={styles.main}>
        ...
        <div className={styles.grid}>
          Presenting Sling, the all in one package which uses React Hooks to
          write components more intuitively without using classes. Sling is
          ...
          integrate with real Server. Sling has integration of Storybook to
