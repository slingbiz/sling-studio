...
export const GENERATE_WIDGET_START = 'GENERATE_WIDGET_START';
export const GENERATE_WIDGET_SUCCESS = 'GENERATE_WIDGET_SUCCESS';
export const GENERATE_WIDGET_ERROR = 'GENERATE_WIDGET_ERROR';
